export const TRANSLATIONS = {
  es: {
    ...
    noAccountDataTitle: 'Sin movimientos por cuenta',
    noAccountDataDesc: 'Cuando registres ingresos o gastos en tus cuentas, aquí verás la comparativa gráfica.',
    noCategoryExpensesTitle: 'Sin gastos registrados',
    noCategoryExpensesDesc: 'Los gastos clasificados por categoría aparecerán aquí.',
    remaining: 'Restante',
  ...
  en: {
    ...
    noAccountDataTitle: 'No account activity yet',
    noAccountDataDesc: 'When you record income or expenses in your accounts, you will see the comparison chart here.',
    noCategoryExpensesTitle: 'No expenses recorded',
    noCategoryExpensesDesc: 'Expenses classified by category will appear here.',
    remaining: 'Remaining',
